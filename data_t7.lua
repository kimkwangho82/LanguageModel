...
cmd:option('--train_small', 'train_small.txt', 'training file')
cmd:option('--train_tiny', 'train_tiny.txt', 'training file')
...
trainSmallData = load_data(opt.train_small, vocab)
trainTinyData = load_data(opt.train_tiny, vocab)
...
torch.save("train_small.th7", trainSmallData)
torch.save("train_tiny.th7", trainTinyData)
